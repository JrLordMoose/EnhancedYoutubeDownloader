...
1. **[Download EnhancedYoutubeDownloader-Setup-v0.4.2.exe](https://github.com/JrLordMoose/EnhancedYoutubeDownloader/releases/download/v0.4.2/EnhancedYoutubeDownloader-Setup-v0.4.2.exe)** (~83 MB)
...
# Installer output: release/EnhancedYoutubeDownloader-Setup-v0.4.2.exe
```
